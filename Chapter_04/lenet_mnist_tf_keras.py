...
# python lenet_mnist_tf_keras.py --train-model 1 --save-trained 1 --weights data/lenet_weights.hdf5
#
...
# python lenet_mnist_tf_keras.py --weights data/lenet_weights.hdf5
...
# a function to build the LeNet model
...
# a function to graph the training history of the model
...
model = build_lenet(width=28, height=28, depth=1, classes=10,
                    ...
                    if args["train_model"] <= 0 else None)
